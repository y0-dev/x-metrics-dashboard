...
const fetchIGFollowerCount = async () => {
  ...
  const data = await response.json();
    ...
    // Extract the metrics
    const metrics = {
        followers_count: data.result.edge_followed_by.count,//data.data.user.edge_followed_by.count,
        following_count: data.result.edge_follow.count,//data.data.user.edge_follow.count,
        posts_count: data.result.edge_owner_to_timeline_media.count//data.data.user.edge_owner_to_timeline_media.count
    };
